                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" name="discount_value" id="discount_value"
                                    class="form-control" value="{{ old('discount_value', $discountCode->discount_value) }}"
                                    min="0" required>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="card border rounded-4 mb-4">
                            ...
                            <div class="card-body p-3">
                                <p class="text-muted small mb-3">Tiers apply escalating discounts when the number of orders
                                    using this code reaches the specified quantity.</p>
                                <div id="tiersContainer">
                                    {{-- Existing tier rows --}}
                                </div>
                                <div id="noTiersMsg" class="text-center text-muted py-3" style="display:none;">
