                                ...
                                <tbody class="top-selling">
                                    <tr>
                                        <td class="text-center lh-1">
                                            <span class="avatar avatar-md">
                                                <img src="{{ asset('build/assets/images/ecommerce/png/36.png') }}" class="p-2 rounded-pill bg-light" alt="">
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center lh-1">
                                            <span class="avatar avatar-md">
                                                <img src="{{ asset('build/assets/images/ecommerce/png/38.png') }}" class="p-2 rounded-pill bg-light" alt="">
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center lh-1">
                                            <span class="avatar avatar-md">
                                                <img src="{{ asset('build/assets/images/ecommerce/png/39.png') }}" class="p-2 rounded-pill bg-light" alt="">
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center lh-1">
                                            <span class="avatar avatar-md">
                                                <img src="{{ asset('build/assets/images/ecommerce/png/40.png') }}" class="p-2 rounded-pill bg-light" alt="">
                                            </span>
                                        </td>
