...
<div class="container" style="direction: rtl; text-align: right;">
    <h1 class="my-4">إضافة اسم SVG جديد</h1>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('svg-names.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        dir="ltr">{{ old('svg_code') }}</textarea>
                    <small class="text-muted">
                        يمكنك لصق كود الـ SVG كامل هنا (&lt;svg ...&gt; ... &lt;/svg&gt;). الحقل اختياري مؤقتًا.
                    </small>
                    @error('svg_code')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
