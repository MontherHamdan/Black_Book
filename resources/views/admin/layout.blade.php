...
<body>
    ...
    @if(auth()->check() && auth()->user()->isDesigner())
        ...
        <div id="global-penalty-banner" class="alert alert-danger text-center fw-bold mb-0 rounded-0 shadow-sm"
            style="display: {{ auth()->user()->isPenalized() ? 'block' : 'none' }}; position: sticky; top: 0; z-index: 99999; font-family: 'Cairo', sans-serif;">
            <i class="fas fa-exclamation-triangle me-2"></i>
            <span>عذراً، لقد تجاوزت الحد الأقصى للتعديلات المسموحة أو تم إيقافك مؤقتاً. لا يمكنك استلام طلبات جديدة
                حالياً.</span>
