    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                @php
                // لو role فاضي لكن is_admin = true اعتبره Admin افتراضيًا
                $defaultRole = $user->role ?: ($user->is_admin ? \App\Models\User::ROLE_ADMIN : null);
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="password" class="form-label">
                                Password <small>(leave blank if not changing)</small>
                            </label>
                            <input
                                type="password"
                                name="password"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select
                                ...
                                <option value="{{ \App\Models\User::ROLE_ADMIN }}"
                                    {{ $selectedRole === \App\Models\User::ROLE_ADMIN ? 'selected' : '' }}>
                                    Admin
                                </option>
