    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <form action="{{ route('specialized-departments.store') }}" method="POST">
                    @csrf
                    <h4 class="mb-4 text-primary">Add New Specialized Department</h4>
                    <div class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="whatsapp_link" id="whatsapp_link" class="form-control"
                                value="{{ old('whatsapp_link') }}" placeholder="https://wa.me/...">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="color" name="color_code" id="color_code" class="form-control form-control-color"
                                    value="{{ old('color_code', '#000000') }}" title="Choose color">
                                <input type="text" class="form-control" id="color_text" value="{{ old('color_code', '#000000') }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-8">
                            ...
                            <textarea name="icon_svg" id="icon_svg" class="form-control" rows="3"
                                placeholder="Paste SVG code here...">{{ old('icon_svg') }}</textarea>
                        </div>
                    </div>

                    <div class="text-end">
                        <button type="submit" class="btn btn-success px-4">Create Department</button>
                    </div>
                </form>
            </div>
        </div>
