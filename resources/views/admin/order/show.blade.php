...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function finalSvgStringToPngBlob(svgString, width = 2000) {
                ...
                try {
                    ...
                    // خلفية بيضاء عشان لما ننسخ للفوتوشوب ما تطلع سوداء
            ...
            document.querySelectorAll('.js-copy-final-svg-btn').forEach(function (btn) {
                btn.addEventListener('click', async function () {
                    ...
                    try {
                        const pngBlob = await finalSvgStringToPngBlob(window.finalDesignSvg, 2000);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function svgToPngBlob(svgUrl, size = 2000) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    img.onload = () => {
                        ...
                        // ✅ FIX #1: خلفية بيضاء صريحة → الفوتوشوب ما يعرضها سودا
                        ctx.fillStyle = '#ffffff';
            ...
            document.querySelectorAll('.copy-for-ps-btn').forEach(btn => {
                btn.addEventListener('click', async function () {
                    ...
                    try {
                        const blob = await svgToPngBlob(this.dataset.url, 2000);
